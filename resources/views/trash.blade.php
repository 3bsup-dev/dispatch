                        ...
                        <table class="table table-striped bg-white">
                            ...
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class=" text-end" scope="col" width="150px"> <a class="btn btn-danger btn-sm"
                                            href="{{ route('clean_trash') }}"><i class="fa fa-trash"></i> Esvaziar
                                            lixeira</a></th>
                                </tr>
                            </thead>
                                ...
                                @foreach ($dispatch as $dispatchs)
                                    <tr>
                                        ...
                                        <td colspan="2" scope="row">
                                            <a href="{{ route('action_dispatch', ['id_dispatch' => $dispatchs->id, 'action' => 6]) }}"
                                                class="btn btn-success btn-sm" title="Restaurar"><i
