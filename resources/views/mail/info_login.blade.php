        ...
        <td align="center" valign="top">
            ...
            <table style="border-bottom: 2px solid #fff200" width="640" border="0" cellspacing="0" cellpadding="10" bgcolor="#4d4d4d" class="100p">
                <tr>
                    ...
                    <td align="center"   width="202" style="font-size:15px; color:#FFFFFF;"><font face="'Roboto', Arial, sans-serif">Informações de usuário</font></td>
            ...
            <table width="640" border="0" cellspacing="0" cellpadding="10" bgcolor="#ffffff" class="100p">
                <tr>
                    <td align="center"  width="402" style="font-size:16px; color:#848484;"><font face="'Roboto', Arial, sans-serif"><span style="color:#2a9d47; font-size:30
                    px;">Prezado Sr(a). {{  $info['name'] }}</span>
                        </font>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td align="left"  width="402" style="font-size:20px; color:#000;"><font face="'Roboto', Arial, sans-serif">
                        <div class="c-b fs-13 modal-body">
                            <h5>SEGUE ABAIXO SUAS INFORMAÇÕES DE LOGIN:</h5><br>
                             <strong>- Usuário:</strong>  {{  $info['login']}} <br>
                             <strong>- Senha provisória:</strong> {{  $info['password']}}
                             <ul class="mt-3">
                                 <li> Algumas questões importantes de segurança devem ser observadas:</li>
                                 <li> Para a troca da senha provisória basta acessar seu perfil . A alteração da senha ocorre de forma imediata;</li>
                                 <li>Atente para a forma da senha (deverá ser alfanumérica com no mínimo 8 caracteres - incluir letras maiúsculas, minúsculas e números)</li>
