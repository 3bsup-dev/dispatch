        ...
        <td align="center" valign="top">
            ...
            <table style="border-bottom: 2px solid #fff200" width="640" border="0" cellspacing="0" cellpadding="10" bgcolor="#4d4d4d" class="100p">
                <tr>
                    ...
                    <td align="center"   width="202" style="font-size:15px; color:#FFFFFF;"><font face="'Roboto', Arial, sans-serif">MENSAGEM DO COMANDANTE</font></td>
            ...
            <table width="640" border="0" cellspacing="0" cellpadding="10" bgcolor="#ffffff" class="100p">
                <tr>
                    <td align="center"  width="402" style="font-size:16px; color:#848484;"><font face="'Roboto', Arial, sans-serif"><span style="color:#2a9d47; font-size:24px;">Prezado(a) Sr(a). {{ $info['name'] }}, há uma mensagem do comandante</span>
                        </font>
                    </td>
                </tr>
            </table>
            <table width="640" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" class="100p">
                <tr>
                    <td align="center"  width="402" style="font-size:20px; color:#000;"><font face="'Roboto', Arial, sans-serif">
                       <strong>Mensagem:</strong><br> {{ $info['message'] }}
                        </font>
                    </td>
                </tr>
            </table>
