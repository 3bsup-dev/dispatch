                        ...
                        @if (isset($dispatch[0]))
                            ...
                            @if ($dispatch[0]->status == 0)
                                ...
                                <div class="fs-25">
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#cancel_dispatch"
                                        class="m-t-30 btn btn-danger">CANCELAR</a>
                                </div>
                            @elseif($dispatch[0]->status == 1)
                                <h1>SOLICITAÇÃO DE DESPACHO</h1>
                                <p class="c-b p-t-85 p-b-85 fs-30">Chegou a sua vez desloque-se até a sala do comandante.
                                </p>
                                <div class="fs-25 ">
                                    <a data-bs-toggle="modal" data-bs-target="#cancel_dispatch"
                                        class="m-t-35 btn btn-danger">CANCELAR</a>
                                </div>
                            @endif
                        @else
                            ...
                            <form action="{{ route('request_dispatch') }}" method="POST">
                                @csrf
                                <textarea placeholder="Assunto:" class="textarea subject-dispatch fs-18" name="descripition"
                                    id="descripition"></textarea>
                                <div class="notification">
                                    <input checked class="form-check-input" type="checkbox" value="1" id="notification"
                                        name="notification">
        ...
        <div class=" modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="c-b modal-header">
                    <h5 class=" modal-title" id="cancel_dispatch">{{ session('user')['professionalName'] }}, deseja mesmo
                        cancelar sua solicitação de despacho ?</h5>
            ...
            <div class=" modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" onclick="hide()"
